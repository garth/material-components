...
export default class Calendar extends Component {
  ...
  onChange(day, validDay) {
    const { month, onChange, year } = this.props;
  ...
  render() {
    const { secondaryColor, secondaryFontColor, typographyColor } = this.context.componentStyle;
    const { className, locale, month, onNavigate, onChange, value, style, titleFormat, validDays, year } = this.props;
