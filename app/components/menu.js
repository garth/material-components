...
<Menu rightAlign isOpen={showMenuProp} onClose={hideMenuFunc}>
  ...
  <Menu.Item showIcon selected={selectedOption===2} onTouchTap={() => setSelectedOption(2)}>Option 2</Menu.Item>
        ...
        <div style={{ margin: '24px 0' }}>
          ...
          <Button style={{ margin: '0' }} primary onTouchTap={() => signals.simpleMenuOpened()}>
            Simple Menu
          </Button>

          <Button style={{ margin: '0 16px' }} primary onTouchTap={() => signals.menuOpened()}>
            Menu
          </Button>
          <Menu rightAlign isOpen={menu.showMenu} onClose={() => signals.menuClosed()}>
            ...
            <Menu.Item
              showIcon
              selected={menu.selectedOption === 1}
              onTouchTap={() => signals.selectMenuOption({ value: 1 })}>
              Option 1
            </Menu.Item>
            <Menu.Item
              showIcon
              selected={menu.selectedOption === 2}
              onTouchTap={() => signals.selectMenuOption({ value: 2 })}>
              Option 2
            </Menu.Item>
          </Menu>
        </div>
